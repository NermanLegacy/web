---
title: "Color Fix"
descripion: Osnovna skripta za dodavanje više boja igrača.
---

Ovaj tutorijal treba koristiti sa [GetPlayerColor](../scripting/functions/GetPlayerColor), ako ne koristite [SetPlayerColor](../scripting/functions/SetPlayerColor) u svojoj skripti kada se igrači povezuju.
...
Prvo to postavite na vrh skripte.

Zatim stavite ovo pod OnPlayerConnect callback:

```c
SetPlayerColor(playerid, PlayerColors[playerid % sizeof PlayerColors]);
```

Sada [GetPlayerColor](../scripting/functions/GetPlayerColor) će raditi!

Za nove verzije SA-MP-a možete dodati ovaj niz:
...
Sada nema dupliciranih boja, boje su raspoređene na maksimalan broj slotova, korak boje - 34, a TAB punog servera izgleda kao duga!
